...
const quizStartTime = new Date("September 28, 2025 18:00:00 GMT+0530"); // 6:00 PM IST
...
function setLinkStatus() {
    ...
    if (timerControlStatus === "enable") {
        if (currentTime >= quizStartTime && currentTime < quizEndTime) {
            ...
            statusElement.innerHTML = 'MINDMASH - 30 QNS QUIZ<br>fill within 29/09/2025 6.00 PM IST!';
            ...
            statusElement.innerHTML = 'MINDMASH - FINAL QUIZ<br>monthly quizzes ended';
    ...
    // Priority 3: Default to disabled if neither manual nor timer is enabling it
        ...
        quizShouldBeEnabled = false;
        statusElement.innerHTML = 'MINDMASH - FINAL QUIZ<br>monthly quizzes ended'; // Indicate manual disable
